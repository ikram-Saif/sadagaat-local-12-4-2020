                  ...
                  <div className="tab-content">
                    <div className="tab-pane active p-15" id="register-tab">
                      ...
                      >
                        ...
                        <div
                          className={`${this.state.response.styleClass} bold`}
                          role="alert"
                        >
                        ...
                        <div className="row">
                          <div className="form-group required col-md-5">
                            <label for="" className="control-label float-left">
                              {t("Gender")}
                            </label>
                        ...
                        <div className="row">
                          ...
                          <div className="form-group required col-md-6">
                            <label>
                              {t("If you currently work , what is your job?")}
                            </label>
                        ...
                        <div className="row">
                          ...
                          <div className="form-group required col-md-6">
                            <label>
                              {t(
                                "Did Sadagaat executed any projects in your State?"
                              )}
                            </label>
                            <div className="form-check- form-inline">
                              <div className="radio-inline">
                                <input
                                  ...
                                  onChange={this.handleChange}
                                  checked={
                                    this.state.form.cityProjects === "yes"
                                  }
                                />
                              ...
                              <div className="radio-inline">
                                <input
                                  ...
                                  pattern="^[^\s].+[^\s]$"
                                  checked={
                                    this.state.form.cityProjects === "no"
                                  }
                                />
                              ...
                              <div className="radio-inline">
                                <input
                                  ...
                                  onChange={this.handleChange}
                                  checked={
                                    this.state.form.cityProjects === "dont"
                                  }
                                />
                                <label className="form-check-label" for="">
                                  {t("I Dont Know")}
                        ...
                        <div className="row">
                            ...
                            <div className="form-check- form-inline">
                              <div className="radio-inline">
                                <input
                                  ...
                                  onChange={this.handleChange}
                                  checked={
                                    this.state.form.volunteeredBefore === "yes"
                                  }
                                />
                                <label className="form-check-label" for="1">
                                  {t("Yes")}
                              ...
                              <div className="radio-inline">
                                <input
                                  ...
                                  onChange={this.handleChange}
                                  checked={
                                    this.state.form.volunteeredBefore === "no"
                                  }
                                />
                                <label className="form-check-label" for="">
                                  {t("No")}
                          ...
                          <div className="form-group col-md-12">
                            <label for="">
                              {t(
                                "What projects did you participated in with Sadagaat?"
                              )}
                            </label>
                          ...
                          <div className="form-group col-md-12">
                            <label>
                              {t("How did you know about Sadagaat?")}
                            </label>
                            <div className="form-check- form-inline">
                              <div className="radio-inline">
                                <input
                                  ...
                                  onChange={this.handleChange}
                                  checked={
                                    this.state.form.heardAboutSadagaat ===
                                    "Friends"
                                  }
                                />
                                <label className="form-check-label" for="1">
                        ...
                        <div className="row">
                          <div className="form-group col-md-12">
                            ...
                            <div className="form-check- form-inline">
                              <div className="radio-inline">
                                <input
                                  ...
                                  onChange={this.handleChange}
                                  checked={
                                    this.state.form.volunteeredPeriod ===
                                    "Morning time"
                                  }
                                />
                                <label className="form-check-label" for="1">
                              ...
                              <div className="form-check- form-inline">
                                <div className="radio-inline">
                                  <input
                                    ...
                                    onChange={this.handleChange}
                                    checked={
                                      this.state.form.receiveEmails === "true"
                                    }
                                  />
                                  <label className="form-check-label">
                                    {t("Yes")}
                                ...
                                <div className="radio-inline">
                                  <input
                                    ...
                                    onChange={this.handleChange}
                                    checked={
                                      this.state.form.receiveEmails === "false"
                                    }
                                  />
                                  <label className="form-check-label" for="">
                                    {t("No")}
                            ...
                            <div className="form-group">
                              <button
                                className="btn text-white btn-theme-green btn-lg btn-block mt-15"
                                type="submit"
                              >
                                <span
