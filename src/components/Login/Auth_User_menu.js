  ...
  return (
    <div className="col-md-4">
      <div className="widget no-border m-0">
        <ul
          className={`list-inline ${menuStyle} flip sm-pull-none sm-text-center mt-5`}
        >
          <li className="mt-sm-10 mb-sm-10">
            <a
              className="p-5 font-14 pl-10 pr-10 text-white dropdown-toggle"
              id="dropdownMenu1"
            ...
            <ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
              <li>
                <Link to="/volunteerForm">{t("Volunteer Form")}</Link>
              </li>
              <li>
                {" "}
                <Link onClick={handleClick}>{t("Logout")}</Link>
              </li>
            </ul>
          </li>
        </ul>
