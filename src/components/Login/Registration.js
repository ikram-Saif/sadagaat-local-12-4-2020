...
class Registration extends Component {
  ...
  render() {
    const { t } = this.props;
    const styleClass =
      i18n.dir() === "rtl" ? "pull-right ml-10" : "pull-left mr-10";
      ...
      <div className="tab-pane fade in  p-15" id="register-tab">
        ...
        >
          <div className="icon-box mb-0 p-0">
            <span
              className={`icon icon-bordered icon-rounded icon-sm ${styleClass} mb-0`}
            >
          ...
          <div className="row">
            <div className="form-group required col-md-6">
              <label className="control-label" for="first-name">
                {t("First Name")}
              </label>
              ...
              <input
                ...
                onInvalid={(e) =>
                  this.handleFormErrorMessage(e, t("Please enter a valid name"))
                }
                onInput={function (e) {
          ...
          <div className="row">
            ...
            <div className="form-group required col-md-6">
              <label for="" className="float-left control-label">
                {t("Gender")}
              </label>
              <select
          ...
          <div className="row">
            <div className="form-group required col-md-6">
              ...
              <input
                ...
                onInvalid={(e) =>
                  this.handleFormErrorMessage(
                    e,
                    t("Enter a valid phone number with 10 number or 14")
                  )
                }
                onInput={function (e) {
                  e.target.setCustomValidity(t(""));
            ...
            <div className="form-group required col-md-6">
              ...
              <input
                ...
                title={
                  t("enter date no later than") + moment().format("YYYY-MM-DD")
                }
                onInvalid={(e) =>
                  this.handleFormErrorMessage(
                    e,
          ...
          <div className="row">
            <div className="form-group required col-md-6  has-feedback">
              <label className="control-label" for="form_choose_password">
                {" "}
                {t("password")}
              </label>
