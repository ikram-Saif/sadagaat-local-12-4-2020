              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="schedule-box maxwidth500 bg-lighter mb-30">
                  <div className="schedule-details border-bottom-theme-color-2px clearfix p-15 pt-10">
                    <div
                      className={`text-center pull-left flip bg-theme-colored p-10 pt-5 pb-5 m${styleMr}-10`}
                      key={event.id}
                    >
                    ...
                    <Link to={"/event/" + event.id}>
                      <h4 className="title mt-5 mb-5">{event.name}</h4>

                      <ul
                        className="list-inline font-11 text-gray"
                        style={{ height: "50px" }}
                      >
                        <li>
                          <i className={`fa fa-calendar m${styleMr}-5`} />{" "}
                          {event.startDate}
                        </li>
                        <li>
                          <i className={`fa fa-map-marker ${styleMr}`} />{" "}
                          {event.locationName}
                        </li>
                      </ul>
